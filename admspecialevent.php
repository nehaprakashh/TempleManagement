...
$sql = " SELECT * FROM specialevent ORDER BY seno ";
        ...
        <table>
            ...
            <tr>
                <!-- FETCHING DATA FROM EACH
                    ROW OF EVERY COLUMN -->
                <td><?php echo $rows['seno'];?></td>
                <td><?php echo $rows['sename'];?></td>
                <td><?php echo $rows['secost'];?></td>
                <td><?php echo $rows['sedate'];?></td>
                <td><?php echo $rows['sephoneno'];?></td>
                <td><?php echo $rows['semembers'];?></td>
                <td><?php echo $rows['setprice'];?></td>
                <td><?php echo $rows['sefile'];?></td>
            </tr>
            <?php
                }
            ?>

...
if(isset($_POST['submit'])){
  ...
  $dmembers = $_POST['dmembers'];
  $dtprice = $_POST['dtprice'];
  $dfile = $_POST['dfile'];
	
      $query = "INSERT INTO darshana (dname, dcost, ddate, dphoneno, dmembers, dtprice, dfile) VALUES('$dname', '$dcost', '$ddate', '.$dphoneno.', '$dmembers', '$dtprice', '.$dfile.')";
    ...
    <div class="top">
        ...
        <div class="top1">
            ...
            <form action="" method="POST">
                ...
                <input type="date" name="ddate" required><br><br>
                <label for="number" >PHONE NUMBER</label>
                <input type="number" name="dphoneno" required><br><br>
                <label for="text">MEMBERS:?</label>
                <input type="number" min="1" name="dmembers" value="1" class="qty"><br><br>
                <label for="number">ENTER AMOUNT PAID</label>
                <input type="number" name="dtprice" placeholder="Amount paid" required><br><br>
                <input type='checkbox' name="dpayment" required><span>PAYMENT DONE?</span><br><br>

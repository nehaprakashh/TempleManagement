...
$sql = " SELECT * FROM darshana ORDER BY dno ";
    ...
    <section>
        ...
        <table>
            ...
            <tr>
                ...
                <td><?php echo $rows['dcost'];?></td>
                <td><?php echo $rows['ddate'];?></td>
                <td><?php echo $rows['dphoneno'];?></td>
                <td><?php echo $rows['dmembers'];?></td>
                <td><?php echo $rows['dtprice'];?></td>
                <td><?php echo $rows['dfile'];?></td>
            </tr>
            <?php
                }
            ?>
